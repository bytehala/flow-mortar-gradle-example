...
public class ObjectGraphService {
  ...
  /**
   * A convenience wrapper for {@link mortar.dagger1support.ObjectGraphService#getObjectGraph} to simplify dynamic
   ...
   * MortarScope#buildChild(String)}, and bind {@link mortar.dagger1support.ObjectGraphService} and
  ...
  /**
   * Returns the existing child whose name matches the given {@link mortar.dagger1support.Blueprint}'s
   * {@link mortar.dagger1support.Blueprint#getMortarScopeName()} value. If there is none, a new child is created
   * based on {@link mortar.dagger1support.Blueprint#getDaggerModule()}. Note that
   * {@link mortar.dagger1support.Blueprint#getDaggerModule()} is not called otherwise.
   *
   ...
   * MortarScope#buildChild(String)}, and bind {@link mortar.dagger1support.ObjectGraphService}  instances to them.
   */
